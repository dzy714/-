...
HD_PWD='C:/Users/wen/Desktop/Greedy_snake/xilinx_snake/5_vga/greedy_snake.runs/rom_start_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_start.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_start.tcl
